...
export default function UpdateCompetitionModal({ isOpen, closeModal, onUpdate, competition, form }) {
  // Use the form passed from the parent component
  const { data, setData, errors, processing, put } = form

  // Update form data when the competition prop changes
  useEffect(() => {
    if (competition && isOpen) {
      setData({
        ...
        rounds: competition.rounds || 0,
        description: competition.description || "",
        code: competition.code || generateCompetitionCode()
      });
    }
  }, [competition, isOpen])
  ...
  const handleUpdate = (e) => {
    ...
    // Call the onUpdate function which will handle the Inertia.js form submission
    onUpdate();
  }
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-2xl transform overflow-auto max-h-[90vh] rounded-xl bg-white p-0 text-left align-middle shadow-xl transition-all border border-gray-200">
                ...
                <div className="bg-gradient-to-r from-[#152a4e] to-[#0a1f44] text-white p-6">
